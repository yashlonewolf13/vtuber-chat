...
export default function ConversationPage() {
  ...
  useEffect(() => {
    console.log(' Page audioElement:', !!audioElement, audioElement);
  }, [audioElement]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1a0b2e] via-[#2d1b4e] to-[#4a2c6d] relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        {/* Header */}
        <header className="flex flex-col md:flex-row items-center justify-between px-6 md:px-12 py-6 gap-4">
          {/* Logo */}
          <Link href="/">
        ...
        {/* Main Content Area */}
        <main className="flex-1 px-6 md:px-12 pb-12 flex items-center justify-center">
          <div className="w-full max-w-[1400px] grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            {/* Left Side - Avatar */}
